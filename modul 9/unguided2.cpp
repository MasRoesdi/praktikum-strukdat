...
int main()
{
    ...
    while(true) {
        string options[] = {
            "Tampilkan node", "Tampilkan node (detail)", "Tampilkan child", "Tampilkan descendant", "Ukuran tree", "Tinggi tree", "Karakteristik tree",
            "Buat root", "Tambah child (kiri)", "Tambah child (kanan)",
            "Ganti `current node`", "Update data node",
            "Urutkan node (Pre-Order)", "Urutkan node (In-Order)", "Urutkan node (Post-Order)",
